        ...
        j = function () {
            ...
            return c.mixin(b.prototype, d, {
                ...
                _compareQueryToInputValue: function () {
                    var a = removeAcento(this.getInputValue()),
                        b = f(this.query, a),
        ...
        k = function () {
            ...
            return c.mixin(b.prototype, d, {
                ...
                _show: function () {
                    ...
                    if (!$('.tt-dropdown-menu').hasClass('active')){
                        $('.mascara').addClass('active'); //TCK 2186
                    }
                },
                _hide: function () {
                    this.$menu.hide(); 
                    $('.mascara').removeClass('active');//TCK 2186
                },
                _moveCursor: function (a) {
                    ...
                    console.log('moveu');
                    $("div.tt-suggestion").removeClass('tt-first');
                },
                ...
                open: function () {
                    ...
                    console.log('open');
                    console.log(this.getSuggestionUnderCursor());
                    console.log(this.getFirstSuggestion());
                    
                    if(this.getSuggestionUnderCursor() == null && this.getFirstSuggestion() != null){
                        $("div.tt-suggestion:contains('"+this.getFirstSuggestion().value+"')").addClass('tt-first').addClass('tt-is-under-cursor');
                    }
