<?php
	...
	class Imovel extends \ActiveRecord\Model {
		 ...
		 * @return array
         */
		public static function findTipos($finalidade = "prontos"){
			switch($finalidade){
				case 'prontos':
					$where = 'AND i.ValorVenda <> 0';
					break;
				case 'locacao':
					$where = 'AND i.ValorLocacao <> 0';
					break;
			}
			$sql = "SELECT
						it.Nome as TipoNome,
						...
						WHERE i.FlagPublico = -1 AND i.FlagRequerAprovacao = 0 ".$where."
