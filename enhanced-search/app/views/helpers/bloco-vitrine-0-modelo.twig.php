              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img id="V2-COD{{entry.itemid}}" src="{{entry.imgurl}}" class="img-responsive" alt="COD{{entry.itemid}}|{{entry.bairronome|convert_encoding('UTF-8','iso-8859-1')}}" data-id="{{entry.itemid}}">
                    <div>
