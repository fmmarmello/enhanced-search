        ...
        <div class="news_pannal">
          <a href="/noticia/{{item.objurl|convert_encoding('UTF-8','iso-8859-1')}}/{{item.id}}/">
            ...
            <div class="news_description">
              <h3>{{(item.titulo|length > 50 ? item.titulo|slice(0, 50) ~ '...' : item.titulo)|convert_encoding('UTF-8','iso-8859-1')}}</h3>
              <p>
                {{(item.sumario|length > 65 ? item.sumario|slice(0, 65) ~ '...' : item.sumario)|convert_encoding('UTF-8','iso-8859-1')}}
              </p>
              <div class="leia-mais">
                <div class="bt_leia">
...
<div class="col-md-4">
  {% include 'helpers/bloco-noticia-newsletter.twig.php' %}
</div>
